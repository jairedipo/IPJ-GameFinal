...
public class ControlPlayer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            movendo = false;
            HP = 0; // Garantir que o player não recuperou HP depois de morto
    ...
    void Atacar(ControlEnemy inimigo)
    {
    ...
    public void receberDano(ControlEnemy atacante, int dano)
    {
    ...
    void refletirAtaque(ControlEnemy inimigo, int danoRefletido)
    {
